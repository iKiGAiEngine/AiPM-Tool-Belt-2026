  ...
  return (
    <>
      <style>{`
        ...
        .opt-a-input::placeholder { color: #4A4F60; }
        .opt-a-btn {
          width: 100%;
          padding: 0.75rem;
        ...
        .opt-a-btn:hover { filter: brightness(1.1); }
        .opt-a-tag {
          position: absolute;
      ...
      <div className="opt-a" style={{
        ...
        <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none" }}>
          ...
          <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%", opacity: 0.04 }}>
            <defs><pattern id="grid" width="80" height="80" patternUnits="userSpaceOnUse"><path d="M 80 0 L 0 0 0 80" fill="none" stroke="rgba(200,164,78,1)" strokeWidth="1"/></pattern></defs>
        ...
        <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: 420 }}>
          ...
          <div style={{ position: "relative" }}>
            <span className="opt-a-tag">Option A — Text Contrast</span>
          </div>

          <div
            className="opt-a-card"
            style={{
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.85rem", marginBottom: "2rem" }}>
              ...
              <span style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: "1.65rem", fontWeight: 700, letterSpacing: "-0.01em" }}>
                ...
                {/* OPTION A CHANGE: "Tool Belt" is still var(--text) ≈ #9A9FAE — unchanged */}
                <span style={{ color: "#9A9FAE" }}> Tool Belt</span>
              </span>
            </div>

            {/* OPTION A CHANGE: heading → white */}
            ...
            {/* OPTION A CHANGE: subtitle → #B8BCC8 */}
            ...
            <div style={{ marginBottom: "1rem" }}>
              {/* OPTION A CHANGE: labels → #B8BCC8 */}
              <label style={{ display: "block", fontSize: "0.8rem", fontWeight: 500, color: "#B8BCC8", marginBottom: "0.4rem" }}>Email</label>
              <input className="opt-a-input" type="email" placeholder="you@company.com" value={email} onChange={e => setEmail(e.target.value)} />
            </div>

            <div style={{ marginBottom: "0.5rem" }}>
              <label style={{ display: "block", fontSize: "0.8rem", fontWeight: 500, color: "#B8BCC8", marginBottom: "0.4rem" }}>Password</label>
              <div style={{ position: "relative" }}>
                <input className="opt-a-input" type={showPw ? "text" : "password"} placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} style={{ paddingRight: "2.5rem" }} />
                <button type="button" className="pw-toggle-a" onClick={() => setShowPw(p => !p)}>
            ...
            <button className="opt-a-btn">Sign In</button>
          </div>
          ...
          <div style={{ marginTop: 16, background: "rgba(200,164,78,0.06)", border: "1px solid rgba(200,164,78,0.15)", borderRadius: 10, padding: "0.75rem 1rem", fontSize: "0.75rem", color: "#9A9FAE", fontFamily: "'DM Sans', sans-serif" }}>
            ...
            "Sign in" heading → <span style={{ color: "#fff" }}>#FFFFFF</span> &nbsp;·&nbsp;
            Labels + subtitle → <span style={{ color: "#B8BCC8" }}>#B8BCC8</span>
            <br />Card opacity &amp; glow: <em>unchanged</em>
          </div>
        </div>
      </div>
    </>
